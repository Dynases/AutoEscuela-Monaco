...
#Region "SERVICIO VENTA"
    ...
    Public Shared Function L_prListarAlumnosVenta(_vctipo As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prServicioVentaDetalleServiciosEscuela(_vcnumi As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prGeneralServicioEscuela(_dt As DataTable, _vctipo As Integer) As DataTable
        Dim _Tabla As DataTable
        ...
        _listParam.Add(New Datos.DParametro("@vcuact", L_Usuario))
        _listParam.Add(New Datos.DParametro("@vctipo", _vctipo))
        _listParam.Add(New Datos.DParametro("@TV0021", "", _dt))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TV002", _listParam)
    ...
    Public Shared Function L_fnGrabarVentaAlumno(ByRef _vcnumi As String, _vcsector As Integer, _vcalm As Integer, _vcfdoc As String, _vcclie As Integer, _vcfvcr As String, _vctipo As Integer, _vcest As Integer, _vcobs As String, _vcdesc As Double, _vctotal As Decimal, _detalle As DataTable,
        ...
        Return _resultado
    End Function
    Public Shared Function L_fnModificarVentaAlumno(ByRef _vcnumi As String, _vcsector As Integer, _vcalm As Integer, _vcfdoc As String, _vcclie As Integer, _vcfvcr As String, _vctipo As Integer, _vcest As Integer, _vcobs As String, _vcdesc As Double, _vctotal As Decimal, _detalle As DataTable,
                                        _vcmoneda As Integer, _vcbanco As Integer) As Boolean
        Dim _resultado As Boolean
        ' @vcnumi  ,@vcsector ,@vcalm ,@vcfdoc ,@vcclie ,@vcfvcr ,@vctipo ,
        '@vcest ,@vcobs ,@vcdesc ,@vctotal ,@vcmoneda,@vcbanco 
    ...
    Public Shared Function L_prVentasCajaDetalleTodosSucursal(fechaI As String, fechaF As String) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prVentasCajaTipoVentaTodosSucursal(fechaI As String, fechaF As String) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prServicioVentaBorrarAlumnos(_numi As String, ByRef _mensaje As String) As Boolean
    ...
    Public Shared Function L_prReporteServicioVentaClienteAlumno(_NumiVenta As Integer) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 7))
        _listParam.Add(New Datos.DParametro("@vcnumi", _NumiVenta))
        _listParam.Add(New Datos.DParametro("@vcuact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TV002", _listParam)
