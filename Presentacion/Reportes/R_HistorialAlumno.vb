...
Public Class R_HistorialAlumno
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_HistorialAlumno.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_HistorialAlumno
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_HistorialAlumno = New R_HistorialAlumno()
        rpt.Site = Me.Site
        Return rpt
    End Function
