...
Public Class R_VentaCaja
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_VentaCaja.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_R_TipoVentarpt__total() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedR_VentaCaja
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_VentaCaja = New R_VentaCaja()
        rpt.Site = Me.Site
        Return rpt
    End Function
