...
#Region "METODOS SOBRECARGADOS"
    ...
    Public Overrides Function _PMOGrabarRegistro() As Boolean
        ...
        If res Then
            ...
            Dim info As New TaskDialogInfo("clases practicas".ToUpper, eTaskDialogIcon.Users, "clases practicas".ToUpper, "¿Desea programar las clases practicas del alumno registrado?".ToUpper, eTaskDialogButton.Yes Or eTaskDialogButton.Cancel, eTaskDialogBackgroundColor.Blue)
